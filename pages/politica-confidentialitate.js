...
export default function PoliticaConfidentialitate() {
  ...
  return (
    <div className="bg-white text-gray-900 py-12 px-6 md:px-20">
      <Head>
        <title>{locale === 'ro' ? 'Politica de Confidențialitate - Apexor' : 'Privacy Policy - Apexor'}</title>
        <meta
          name="description"
          content={
            locale === 'ro'
              ? 'Citește Politica de Confidențialitate Apexor. Află cum colectăm, utilizăm și protejăm datele tale personale în acord cu GDPR.'
              : 'Read Apexor Privacy Policy. Learn how we collect, use, and protect your personal data in accordance with GDPR.'
          }
        />
        <meta property="og:title" content={locale === 'ro' ? 'Politica de Confidențialitate Apexor' : 'Apexor Privacy Policy'} />
        <meta
        ...
        <link rel="canonical" href={`https://apexor.ro/${locale === 'ro' ? 'ro' : 'en'}/politica-confidentialitate`} />
      </Head>
      <div className="max-w-5xl mx-auto text-sm leading-relaxed text-justify">
        {locale === 'ro' ? (
          <>
            ...
            <p>
              S.C. Apexor S.R.L., cu sediul social în Oradea, Str. Paltinului, Nr. 6, jud. Bihor,
              înmatriculată la Registrul Comerţului sub nr. J05/134/2019, având C.U.I. RO40423719,
              email: office@apexor.ro, este deplin răspunzătoare de procesarea datelor cu caracter
            ...
            <p className="mb-4">
              1.1. Apexor este un operator de date cu caracter personal, asa cum este definit de legislatia in vigoare,
            ...
            <p className="mb-4">
              Apexor utilizeaza datele dumneavostra cu caracter personal in mod legal, in conformitate cu prevederile legale aplicabile si in totala conformitate cu prevederile Regulamentului GDPR, specific art. 6.1, astfel:
            </p>
            <ul className="list-disc list-inside mb-4">
              ...
              <li><strong>3.2</strong> In baza interesului legitim, pentru:
                <ul className="list-disc list-inside ml-6">
                  ...
                  <li>Informari despre compania Apexor ;</li>
                  <li>Informari despre produsele si serviciile Apexor ;</li>
                  ...
                  <li>Pentru comunicari privind evenimentele Apexor (inclusiv poze sau filmari de le evenimentele Apexor)</li>
                </ul>
              </li>
              ...
              <li><strong>3.5</strong> Pentru apararea drepturilor noastre legale:
                <ul className="list-disc list-inside ml-6">
                  <li>In cazul încălcării drepturilor Apexor, a utilizatorilor, a altor candidați, a angajaților și a altor persoane vizate, sau în cazurile prevăzute de lege.</li>
                </ul>
              </li>
            </ul>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Datele cu caracter personal colectate de catre Apexor sunt prelucrate in Uniunea Europeana, in locatiile Apexor, la furnizori de servicii a infrastructurii IT&amp;C si/sau furnizori de aplicatii specifice. In dezvoltarea infrastructurii IT&amp;C Apexor a tinut cont de cele mai bune practici din domeniu, astfel:
            </p>
            <ul className="list-disc list-inside mb-4 ml-6">
              ...
              <li>Aplicatiile specifice activitatii Apexor sunt actualizate periodic pe masura ce furnizorii de tehnologie publica patch-uri;</li>
            ...
            <p className="mb-4">
              Ca persoană vizată aveți drepturi specifice cu privire la datele cu caracter personal pe care le colectăm de la dumneavoastră. Apexor vă va respecta drepturile individuale și se va ocupa de interesele dumneavoastră în mod corespunzător.
            </p>
            <ul className="list-disc list-inside mb-4 ml-6">
            ...
            <p className="mb-4">
              Pentru a exercita drepturile, vă rugăm să ne trimiteți o solicitare scrisă și semnată la sediul nostru sau la adresa de email office@apexor.ro. Putem solicita informații suplimentare pentru a verifica identitatea solicitantului.
            </p>
            <h2 className="text-xl font-semibold mt-10 mb-4 text-blue-900">12. ACTUALIZAREA NOTEI DE INFORMARE</h2>
            <p className="mb-4">
              Prezenta Notă de Informare este revizuită periodic pentru a include toate măsurile tehnice și organizatorice introduse de Apexor pentru a contribui la un mediu informatic echilibrat și securizat.
            </p>
          </>
        ) : (
          <>
            ...
            <p className="mb-4">
              When you send an email about a potential order to one of the Apexor representatives.
            </p>
            <p className="mb-4">
              <strong>2.3. Consent</strong> Apexor may process your data based on your express and freely given consent. By consent of the data subject we mean any freely given, specific, informed and unambiguous indication of the data subject’s wishes by which he or she, by a statement or by a clear affirmative action, signifies agreement to the processing of personal data relating to him or her.
            </p>
            <h2 className="text-xl font-semibold mt-10 mb-4 text-blue-900">3. PURPOSE AND LEGALITY OF PERSONAL DATA PROCESSING</h2>
            <p className="mb-4">
              Apexor uses your personal data legally, in accordance with applicable legal provisions and in full compliance with the provisions of the GDPR Regulation, specifically art. 6.1, as follows:
            </p>
            <ul className="list-disc list-inside mb-4">
              ...
              <li><strong>3.2</strong> Based on legitimate interest, for:
                <ul className="list-disc list-inside ml-6">
                  ...
                  <li>Information about Apexor company;</li>
                  <li>Information about Apexor products and services;</li>
                  ...
                  <li>For communications regarding Apexor events (including photos or videos from Apexor events)</li>
                </ul>
              </li>
              ...
              <li><strong>3.5</strong> For defending our legal rights:
                <ul className="list-disc list-inside ml-6">
                  <li>In case of violation of the rights of Apexor, users, other candidates, employees, and other data subjects, or in cases provided by law.</li>
                </ul>
              </li>
            </ul>
            <p className="mb-4">
            ...
            <p className="mb-4">
              The personal data collected by Apexor is processed in the European Union, at Apexor locations, at IT&C infrastructure service providers and/or specific application providers. In developing the IT&C infrastructure, Apexor has taken into account best practices in the field, as follows:
            </p>
            <ul className="list-disc list-inside mb-4 ml-6">
              ...
              <li>Applications specific to Apexor activity are updated periodically as technology providers release patches;</li>
            ...
            <p className="mb-4">
              As a data subject, you have specific rights regarding the personal data we collect from you. Apexor will respect your individual rights and will handle your interests appropriately.
            </p>
            <ul className="list-disc list-inside mb-4 ml-6">
            ...
            <p className="mb-4">
              To exercise your rights, please send us a written and signed request at our headquarters or at the email address office@apexor.ro. We may request additional information to verify the identity of the applicant.
            </p>
            <h2 className="text-xl font-semibold mt-10 mb-4 text-blue-900">12. UPDATING THIS INFORMATION NOTICE</h2>
            <p className="mb-4">
              This Information Notice is periodically reviewed to include all technical and organizational measures introduced by Apexor to contribute to a balanced and secure information environment.
            </p>
          </>
        )}
      </div>
